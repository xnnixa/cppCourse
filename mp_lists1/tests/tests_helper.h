...
inline BlockPNG listToImage(List<RGBAPixel> const& list, unsigned width, unsigned height) {
    BlockPNG ret;
    ret.resize(width, height);
...
inline List<RGBAPixel> imageToList(PNG const& img, bool reverse = false) {
    List<RGBAPixel> list;
